          ...
          <div key={index} className={`message ${message.sender}`}>
            ...
            {/* //recipes */}
              ...
              return (
                ...
                >
                  <div key={idx} className="card-title" style={{
            borderRadius: "10px", 
            marginBottom: "10px",
          }}>
                    <img
                    ...
                    />
                    <div className="card-body d-flex" style={{justifyContent:"space-between", alignItems:"center"}}>
                      <h5
                      style={{
                        paddingLeft:"30px",
                        textAlign: "center",
                      ...
                      {store.favourites.find((item)=> item.title == recipe.title)? (<svg onClick={()=> actions.deleteFavourite(recipeId)} xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#E84A43" className="bi bi-heart-fill" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314"/>
            </svg>) : (<svg onClick={(()=> actions.addFavourites(recipe.title, recipe.image, recipeId))} xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#E84A43" class="bi bi-heart" viewBox="0 0 16 16">
